def level_1():
    if lvl == 1:
        tiles.set_current_tilemap(tilemap("""
            level1
        """))
    tiles.place_on_random_tile(Flying_Kin, assets.tile("""
        myTile0
    """))
    scene.camera_follow_sprite(Flying_Kin)
    tiles.place_on_random_tile(Chest, assets.tile("""
        myTile
    """))
lvl = 0
Flying_Kin: Sprite = None
Chest: Sprite = None
...
Flying_Kin = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.move_sprite(Flying_Kin, 100, 100)
lvl = 1
level_1()
Flying_Kin.ay = 350